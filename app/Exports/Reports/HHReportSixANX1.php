...
class HHReportSixANX1 implements FromView, withColumnFormatting, WithEvents, WithTitle
{
   ...
   //view
      ...
      $filtered_quotations = collect($this->quotations)->map(function ($q) {
              return [
                  'pcode'         => $q['pcode'],
                  'pname'         => $q['pname'],
                  'avgprice'      => (float)$q['avg'],
   		...
   		return view('household.reports.six-anx1', [
   			'country'               => $this->country,
